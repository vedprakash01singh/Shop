...
export default function ProductCard({ product, onOrder, onClick }) {
  return (
    <div className="card cursor-pointer" onClick={onClick}>
      ...
      <div className="p-3">
        ...
        <button
          ...
          className="mt-2 w-full bg-green-600 text-white text-xs font-medium 
                     py-2 rounded-lg flex items-center justify-center gap-1.5
