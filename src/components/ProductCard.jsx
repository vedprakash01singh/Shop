        ...
        <div className="flex flex-col gap-2 mt-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="w-1/2 bg-blue-600 text-white py-2 rounded-lg flex items-center justify-center hover:bg-blue-700 active:scale-95 transition-all sm:text-xs sm:font-medium gap-1.5"
              disabled={isDisabled}
            >
            ...
            <button
              ...
              className="w-1/2 bg-green-600 text-white py-2 rounded-lg flex items-center justify-center hover:bg-green-700 active:scale-95 transition-all sm:text-xs sm:font-medium gap-1.5"
              disabled={isDisabled}
            >
              <span className="block sm:hidden">
              ...
              <span className="hidden sm:block">Order / ऑर्डर</span>
            </button>
          </div>
        </div>
        {isDisabled && (
           <div className="absolute inset-0 bg-white bg-opacity-80 flex items-center justify-center text-slate-500 text-lg font-semibold">
